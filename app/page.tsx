    ...
    <Container>
      ...
      <Section delay="0.1">
        ...
        <Paragraph>
          ...
          aspernatur enim atque nesciunt accusantium dolorem
          expedita. Lorem ipsum dolor sit amet, consectetur
          adipisicing elit. Omnis tempora dolore nesciunt
          aliquam accusamus adipisci minima architecto,
          asperiores a dicta eius odio ipsa corrupti
          maiores, ducimus culpa, cupiditate soluta dolorum!{" "}
      ...
      <Section delay="0.2">
        ...
        <BioSection>
          ...
          doloribus et vitae consectetur expedita, in dicta
          saepe qui neque soluta voluptas itaque accusamus!
        </BioSection>
        <BioSection>
        ...
        <BioSection>
          ...
          elit. Non aperiam delectus earum iure. Vel quasi,
          quia consequuntur
        </BioSection>
      </Section>
    </Container>
